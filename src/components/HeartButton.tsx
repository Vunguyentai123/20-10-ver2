    ...
    >
      ...
      <div className="relative flex items-center justify-center gap-0">
        ...
        <div className="relative z-10 transition-all duration-[1500ms] ease-in-out group-hover:-translate-x-16">
          ...
          <svg 
            className="w-24 h-24 relative transition-all duration-[1500ms] ease-in-out group-hover:scale-110 group-hover:rotate-12" 
            viewBox="0 0 24 24" 
            fill="none"
          >
            <path 
        ...
        <div className="absolute inset-0 flex items-center justify-center transition-opacity duration-700 delay-700 opacity-100 group-hover:opacity-0 group-hover:duration-300 group-hover:delay-0 z-10">
          ...
          <svg 
            className="w-32 h-32 relative transition-transform duration-[1500ms] ease-in-out group-hover:scale-95" 
            viewBox="0 0 24 24" 
            fill="none"
          >
            <path 
